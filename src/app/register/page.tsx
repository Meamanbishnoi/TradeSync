...
export default function RegisterPage() {
  ...
  return (
    <div style={{ maxWidth: "400px", margin: "80px auto" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", margin: "24px 0", color: "var(--text-secondary)", fontSize: "14px", opacity: 0.6 }}>
      ...
      <button 
        ...
        style={{ width: "100%", padding: "10px", display: "flex", justifyContent: "center", alignItems: "center", border: "1px solid var(--border-color)", backgroundColor: "var(--bg-secondary)" }}
      >
